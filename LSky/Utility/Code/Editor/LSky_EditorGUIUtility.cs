...
/// Editor GUI Utility:
///----------------------------------------------
/// Description: Utility for custom inspectos.
/////////////////////////////////////////////////
...
namespace Rallec.LSky.Utility
{
    ...
    public static class LSky_EditorGUIUtility
    {
        #region [Serparator]
        ...
        public static void ShurikenHeader(string tex, GUIStyle texStyle, LSky_ShurikenStyle style)
        {
            switch(style)
            {
                case LSky_ShurikenStyle.TitleHeader:

                EditorGUILayout.BeginHorizontal(ShurikenStyleTitleHeader, GUILayout.Height(25));

                break;

                case LSky_ShurikenStyle.Title:

                EditorGUILayout.BeginHorizontal(ShurikenStyleTitle, GUILayout.Height(25));

                break;

                case LSky_ShurikenStyle.Tab:
        ...
        public static void ShurikenHeader(string tex, GUIStyle texStyle, int height, LSky_ShurikenStyle style)
        {
        ...
        public static void ShurikenFoldoutHeader(string text, SerializedProperty foldout, LSky_ShurikenStyle style)
        {
        ...
        public static void ShurikenFoldoutHeader(string text, ref bool foldout, LSky_ShurikenStyle style)
        {
        ...
        public static void ShurikenFoldoutHeader(string text, SerializedProperty foldout, int height, LSky_ShurikenStyle style)
        {
        ...
        public static void ShurikenFoldoutHeader(string text, ref bool foldout, int height, LSky_ShurikenStyle style)
        {
